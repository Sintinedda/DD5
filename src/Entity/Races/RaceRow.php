...
#[ORM\Entity(repositoryClass: RaceRowRepository::class)]
class RaceRow
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?RaceTable $tableau = null;
    ...
    public function getTableau(): ?RaceTable
    {
        return $this->tableau;
    }

    public function setTableau(?RaceTable $tableau): static
    {
