...
#[ORM\Entity(repositoryClass: ItemRowRepository::class)]
class ItemRow
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?ItemTable $tableau = null;
    ...
    public function getTableau(): ?ItemTable
    {
        return $this->tableau;
    }

    public function setTableau(?ItemTable $tableau): static
    {
