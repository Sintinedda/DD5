...
#[ORM\Entity(repositoryClass: ItemListeRepository::class)]
class ItemListe
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\ManyToMany(targetEntity: ItemSubcategory::class, mappedBy: 'listes')]
