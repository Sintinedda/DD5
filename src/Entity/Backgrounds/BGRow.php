...
#[ORM\Entity(repositoryClass: BGRowRepository::class)]
class BGRow
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function getTableau(): ?BGTable
    {
        return $this->tableau;
    }

    public function setTableau(?BGTable $tableau): static
    {
