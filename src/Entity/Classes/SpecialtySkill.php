...
class SpecialtySkill
{
    ...
    /**
     * @var Collection<int, SpecialtyListe>
     */
    #[ORM\OneToMany(targetEntity: SpecialtyListe::class, mappedBy: 'skill')]
    private Collection $listes;

    /**
     * @var Collection<int, SpecialtyTable>
     */
    #[ORM\OneToMany(targetEntity: SpecialtyTable::class, mappedBy: 'skill')]
    private Collection $tables;

    /**
     * @var Collection<int, SpecialtyItem>
     */
    #[ORM\ManyToMany(targetEntity: SpecialtyItem::class, mappedBy: 'skills')]
    private Collection $specialties;

    #[ORM\OneToOne(mappedBy: 'specialty', cascade: ['persist', 'remove'])]
    private ?SB $sB = null;
    ...
    /**
     * @return Collection<int, SpecialtyListe>
     */
    ...
    public function addListe(SpecialtyListe $liste): static
    {
    ...
    public function removeListe(SpecialtyListe $liste): static
    {
    ...
    public function removeSpecialty(SpecialtyItem $specialty): static
    {
        if ($this->specialties->removeElement($specialty)) {
            $specialty->removeSkill($this);
        }

        return $this;
    }

    public function getSB(): ?SB
    {
        return $this->sB;
    }

    public function setSB(?SB $sB): static
    {
        // unset the owning side of the relation if necessary
        if ($sB === null && $this->sB !== null) {
            $this->sB->setSpecialty(null);
        }

        // set the owning side of the relation if necessary
        if ($sB !== null && $sB->getSpecialty() !== $this) {
            $sB->setSpecialty($this);
        }
