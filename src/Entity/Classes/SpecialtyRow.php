...
#[ORM\Entity(repositoryClass: SpecialtyRowRepository::class)]
class SpecialtyRow
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?SpecialtyTable $tableau = null;
    ...
    public function getTableau(): ?SpecialtyTable
    {
        return $this->tableau;
    }

    public function setTableau(?SpecialtyTable $tableau): static
    {
