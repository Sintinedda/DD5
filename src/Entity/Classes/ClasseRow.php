...
#[ORM\Entity(repositoryClass: ClasseRowRepository::class)]
class ClasseRow
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?ClasseTable $tableau = null;
    ...
    public function getTableau(): ?ClasseTable
    {
        return $this->tableau;
    }

    public function setTableau(?ClasseTable $tableau): static
    {
