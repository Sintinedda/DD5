...
#[ORM\Entity(repositoryClass: SpellRowRepository::class)]
class SpellRow
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    private ?SpellTable $tableau = null;
    ...
    public function getTableau(): ?SpellTable
    {
        return $this->tableau;
    }

    public function setTableau(?SpellTable $tableau): static
    {
