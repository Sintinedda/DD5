...
#[Route('/items/item/category')]
final class ItemCategoryController extends AbstractController
{
    #[Route(name: 'app_items_item_category_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_items_item_category_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_items_item_category_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_items_item_category_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_items_item_category_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_items_item_category_delete', methods: ['POST'])]
