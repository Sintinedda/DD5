...
#[Route('/classes/classe')]
final class ClasseController extends AbstractController
{
    #[Route(name: 'app_classes_classe_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_classes_classe_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_classes_classe_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_classes_classe_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_classes_classe_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_classes_classe_delete', methods: ['POST'])]
